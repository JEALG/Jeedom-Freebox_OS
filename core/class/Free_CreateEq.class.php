...
class Free_CreateEq
{
    ...
    private static function createEq_disk_SP($logicalinfo, $templatecore_V4, $order = 0)
    {
        ...
        if ($result != false) {
            log::add('Freebox_OS', 'debug', '| :fg-success:───▶︎ ' . (__('Ajout des commandes spécifiques pour', __FILE__)) . ' ::/fg: ' . $logicalinfo['diskName'] . ' - STANDARD');
            ...
            log::add('Freebox_OS', 'debug', '| :fg-success:───▶︎ ' . (__('Fin Ajout des commandes spécifiques pour', __FILE__)) . ' ::/fg: ' . $logicalinfo['diskName'] . ' : ' . '[  OK  ]');
